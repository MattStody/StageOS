...
export const PERFORMANCE_DATES: PerformanceDate[] = [
  ...
  // First week: live per-performance data synced from Spektrix
  { id: 'perf-1-1',  productionId: 'prod-1', date: '2026-09-15', time: '20:00', status: 'completed', notes: 'Opening Night',
    spektrixInstanceId: '46001', ticketsSold: 2868, grossRevenue: 415860, capacityPct: 98, totalSeats: 2932, avgTicketPrice: 145, spektrixSyncedAt: '2026-09-16T07:45:00Z' },
  { id: 'perf-1-2',  productionId: 'prod-1', date: '2026-09-16', time: '14:00', status: 'completed', notes: 'Matinee',
    spektrixInstanceId: '46002', ticketsSold: 1876, grossRevenue: 220968, capacityPct: 64, totalSeats: 2932, avgTicketPrice: 118, spektrixSyncedAt: '2026-09-16T19:00:00Z' },
  { id: 'perf-1-3',  productionId: 'prod-1', date: '2026-09-18', time: '19:00', status: 'completed', notes: '',
    spektrixInstanceId: '46003', ticketsSold: 2344, grossRevenue: 300032, capacityPct: 80, totalSeats: 2932, avgTicketPrice: 128, spektrixSyncedAt: '2026-09-19T07:30:00Z' },
  { id: 'perf-1-4',  productionId: 'prod-1', date: '2026-09-19', time: '19:00', status: 'completed', notes: '',
    spektrixInstanceId: '46004', ticketsSold: 2753, grossRevenue: 379914, capacityPct: 94, totalSeats: 2932, avgTicketPrice: 138, spektrixSyncedAt: '2026-09-20T07:30:00Z' },
  { id: 'perf-1-5',  productionId: 'prod-1', date: '2026-09-20', time: '19:00', status: 'completed', notes: '',
    spektrixInstanceId: '46005', ticketsSold: 2491, grossRevenue: 323830, capacityPct: 85, totalSeats: 2932, avgTicketPrice: 130, spektrixSyncedAt: '2026-09-21T07:30:00Z' },
  { id: 'perf-1-6',  productionId: 'prod-1', date: '2026-09-21', time: '20:00', status: 'completed', notes: '',
    spektrixInstanceId: '46006', ticketsSold: 2814, grossRevenue: 380430, capacityPct: 96, totalSeats: 2932, avgTicketPrice: 135, spektrixSyncedAt: '2026-09-22T07:30:00Z' },
  { id: 'perf-1-7',  productionId: 'prod-1', date: '2026-09-22', time: '14:00', status: 'completed', notes: 'Matinee',
    spektrixInstanceId: '46007', ticketsSold: 2198, grossRevenue: 285740, capacityPct: 75, totalSeats: 2932, avgTicketPrice: 130, spektrixSyncedAt: '2026-09-22T19:45:00Z' },
  { id: 'perf-1-8',  productionId: 'prod-1', date: '2026-09-22', time: '20:00', status: 'completed', notes: '',
    spektrixInstanceId: '46008', ticketsSold: 2844, grossRevenue: 391468, capacityPct: 97, totalSeats: 2932, avgTicketPrice: 138, spektrixSyncedAt: '2026-09-23T07:30:00Z' },
  { id: 'perf-1-9',  productionId: 'prod-1', date: '2026-09-23', time: '15:00', status: 'completed', notes: 'Sunday Matinee',
    spektrixInstanceId: '46009', ticketsSold: 2197, grossRevenue: 274625, capacityPct: 75, totalSeats: 2932, avgTicketPrice: 125, spektrixSyncedAt: '2026-09-23T21:00:00Z' },
...
export const GRANTS: Grant[] = [
  {
    ...
    programName: 'Operating Support — Mid-size Theatre B',
    grantType: 'operating',
    status: 'awarded',
    amountRequested: 180000,
    amountAwarded: 165000,
    applicationDeadline: '2026-02-01',
    awardedDate: '2026-05-15',
    reportDeadline: '2027-09-30',
    year: '2026–27',
    notes: 'Annual operating grant. Reporting period ends Aug 31, 2027.',
  },
  {
    id: 'grant-2',
    funder: 'Canada Council for the Arts',
    programName: 'Explore and Create — Creation Projects',
    grantType: 'project',
    status: 'submitted',
    amountRequested: 75000,
    applicationDeadline: '2026-05-15',
    reportDeadline: '2027-03-31',
    year: '2026–27',
    productionId: 'prod-2',
    notes: 'Creation grant for The Silence Between. Decision expected Oct 2026.',
  },
  {
    id: 'grant-3',
    funder: 'Canada Council for the Arts',
    programName: 'Touring — Large-scale Touring',
    grantType: 'touring',
    status: 'under_review',
    ...
    year: '2026–27',
    productionId: 'prod-3',
    notes: 'National touring support for Echoes. Panel review scheduled July 2026.',
  },
  {
    id: 'grant-4',
    funder: 'Ontario Arts Council',
    programName: 'Theatre Organizations — Operating B',
    grantType: 'operating',
    status: 'awarded',
    ...
    reportDeadline: '2027-06-30',
    year: '2026–27',
    notes: 'Core OAC operating support. Next application Jan 2027.',
  },
  {
    id: 'grant-5',
    funder: 'Ontario Arts Council',
    programName: 'Touring — Domestic Touring Assistance',
    grantType: 'touring',
    status: 'drafting',
    ...
    year: '2026–27',
    productionId: 'prod-3',
    notes: 'Ontario-leg touring support for Echoes dates. Draft in progress.',
  },
  {
    id: 'grant-6',
    funder: 'Toronto Arts Council',
    programName: 'Presenting and Commissioning — Production',
    grantType: 'project',
    status: 'submitted',
    ...
    year: '2026–27',
    productionId: 'prod-1',
    notes: "TAC production grant for A Winter's Dream. Decision expected Aug 2026.",
  },
  {
    id: 'grant-7',
    funder: 'Slaight Family Foundation',
    programName: 'Musical Theatre Development Fund',
    grantType: 'commissioning',
    status: 'report_due',
    amountRequested: 40000,
    amountAwarded: 40000,
    applicationDeadline: '2025-10-01',
    awardedDate: '2026-01-20',
    reportDeadline: '2026-07-31',
    year: '2025–26',
    productionId: 'prod-1',
    notes: "Development fund for A Winter's Dream. Final report due end of July.",
  },
  {
    id: 'grant-8',
    funder: 'Metcalf Foundation',
    programName: 'Performing Arts — Emerging Artist Commission',
    grantType: 'commissioning',
    status: 'identified',
    ...
    year: '2026–27',
    productionId: 'prod-1',
    notes: 'Next intake opens Aug 2026. Begin application materials in July.',
  },
]
